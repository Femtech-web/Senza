...
export class FhevmDecryptionSignature {
  ...
  static async loadOrSign(
    ...
    console.log("[FhevmDecryptionSignature] instance type:", typeof instance);
    console.log("[FhevmDecryptionSignature] instance has generateKeypair:", typeof (instance as any)?.generateKeypair);

    if (!instance || typeof (instance as any).generateKeypair !== 'function') {
      console.error("[FhevmDecryptionSignature] Instance does not have generateKeypair method");
      return null;
    }

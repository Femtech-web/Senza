...
export const fhevmMockCreateInstance = async (parameters: {
  ...
  // Initialize the SDK WASM modules if not already done
  if (!sdkInitialized) {
    console.log('[fhevmMock] Initializing WASM modules...');
    await initSDK();
    sdkInitialized = true;
    console.log('[fhevmMock] WASM modules initialized successfully');
  }
